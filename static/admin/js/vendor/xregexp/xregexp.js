...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode catalog. Addon packages for other Unicode
...
/* Adds data for the Unicode `Letter` catalog. Addon packages include other categories, scripts,
